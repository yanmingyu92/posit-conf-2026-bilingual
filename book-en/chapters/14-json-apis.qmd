...
|---|---|---|
| §1–§2: JSON structure and `fromJSON()` behavior | [Official jsonlite documentation](https://jeroen.r-lib.org/jsonlite/) | Referenced |
| §3–§6: requests, errors, credentials, pagination | [Official httr2 documentation](https://httr2.tidyverse.org) | Referenced |
