...
RAG helps a model read your material. MCP, the Model Context Protocol, standardizes how it connects to **tools**. Think of a USB interface: clients such as Positron Assistant or Claude Desktop discover and invoke tools and resources exposed by compatible servers.
...
4. Open Positron Assistant, select polars code, and ask “Rewrite this polars code in dplyr”, adding `#context7`. Observe the documentation-tool calls checking current APIs rather than relying solely on training memory.
:::
